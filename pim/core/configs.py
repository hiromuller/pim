...
ACTION_PROGRESS_SEARCH = 'progress_search'
ACTION_TARGET_LIST = 'target'
ACTION_TARGET_ADD = 'target_add'
ACTION_TARGET_SEARCH = 'target_search'
...
ACTION_DICT = {
                ...
                'ACTION_PROGRESS_SEARCH':ACTION_PROGRESS_SEARCH,
                'ACTION_TARGET_LIST':ACTION_TARGET_LIST,
                'ACTION_TARGET_ADD':ACTION_TARGET_ADD,
                'ACTION_TARGET_SEARCH':ACTION_TARGET_SEARCH,
